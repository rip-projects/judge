...
<form action="<?php echo current_url() ?>" method="post" class="ajaxform">
    ...
    <div class="action-buttons">
        <input type="submit" />
        or
        <a href="#" class="button" id="add_field">Add Field</a>
    </div>
</form>
