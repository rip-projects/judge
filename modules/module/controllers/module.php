        ...
        $this->_validation = array(
            'add' => array(
                array(
                    'field' => 'name',
                    'label' => l('Name'),
                    'rules' => 'required|callback__check_module_name|callback__check_table_name',
                ),
                array(
                    'field' => 'controller_base_class',
                    'label' => l('Controller Base Class'),
                    'rules' => 'required',
                ),
                array(
                    'field' => 'model_base_class',
                    'label' => l('Model Base Class'),
                    'rules' => 'required',
                ),
            ),
        );
