 ...
 * -----
 * 
 * File generated: Wed Jan 12 16:57:45 GMT 2011
 */
...
D.append(j=b('<div id="fancybox-content" class="the-content"></div>'),E=b('<a id="fancybox-close"></a>'),n=b('<div id="fancybox-title"></div>'),z=b('<a href="javascript:;" id="fancybox-left"><span class="fancy-ico" id="fancybox-left-ico"></span></a>'),A=b('<a href="javascript:;" id="fancybox-right"><span class="fancy-ico" id="fancybox-right-ico"></span></a>'));E.click(b.fancybox.close);t.click(b.fancybox.cancel);z.click(function(a){a.preventDefault();b.fancybox.prev()});A.click(function(a){a.preventDefault();b.fancybox.next()});
...
/* Youtube Thumbnail. http://jquery-howto.blogspot.com/2009/05/jyoutube-jquery-youtube-thumbnail.html */
$.extend({jYoutube: function( url, size ){if(url === null){ return ""; }size = (size === null) ? "big" : size;var vid;var results;results = url.match("[\\?&]v=([^&#]*)");vid = ( results === null ) ? url : results[1];if(size == "small"){return "http://img.youtube.com/vi/"+vid+"/1.jpg";}else {return "http://img.youtube.com/vi/"+vid+"/0.jpg";}}});
/* Jquery Javascript PopUp http://swip.codylindley.com/popupWindowDemo.html */
...
(function($,undefined){
  ...
  $.fn.serializeObject = function(){
    ...
    $.each( this.serializeArray(), function(i,o){
        ...
        obj[n] = obj[n] === undefined ? isArray ? [ v ] : v
