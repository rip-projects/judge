...
<html xmlns="http://www.w3.org/1999/xhtml" debug="true">
    <head>
        ...
        <!--<script type="text/javascript" src="js/ajaxfilemanager_c.js"></script>-->
...
<?php
if (file_exists(dirname(__FILE__)) . DIRECTORY_SEPARATOR . 'js' . DIRECTORY_SEPARATOR . 'for_' . CONFIG_EDITOR_NAME . ".js") {
    ?>
            <script type="text/javascript" src="js/<?php echo 'for_' . CONFIG_EDITOR_NAME . '.js'; ?>"></script>
    <?php
}
?>
