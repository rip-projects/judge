<html>
    <head>
        ...
        <script type="text/javascript">
            $(function() {
                $('div.grid-container').lionbars(false);
                // Run the clock
                function timer() {
                    var t = new Date();
                            ...
                            <div class="top-nav top-nav-right right">
                                <ul class="menu">
                                    ...
                                    <li class="user-sys">
                                        ...
                                        <ul>
                                            <li><a href="<?php echo site_url("profile"); ?>">Profile Page</a></li>
                                            <li><a href="<?php echo site_url("user/change_password/" . $USER['id']); ?>">Change Password</a></li>
